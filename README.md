...
|------|-------------|---------|
| `THE CONSTITUTION v1.4.md` | The constitutional text – nine Laws, amendment protocol, provenance & compliance sections | 1.4 |
...
| `CHANGELOG.md` | Complete version history (v1.0 → v1.4) | – |
| `LICENSE` | Apache 2.0 | – |
...
## 🧪 Falsification Test Harness (Planned)
...
- [Read THE CONSTITUTION v1.4](./THE%20CONSTITUTION%20v1.4.md)
- [Read THE CONSTITUTIONAL COMMENTARY v1.1](./THE%20CONSTITUTIONAL%20COMMENTARY%20v1.1.md)
- [View version history](./CHANGELOG.md)
- [Compliance checklist for adopters](./COMPLIANCE.md) (planned)
